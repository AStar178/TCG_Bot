...
public abstract class MeleeAttack : Ability
{
    ...
    async void PlayerAttack(BattleS battle)
    {
        ...
        tween = battle.PlayerKnight.gameObject.transform.DOMoveX(battle.transform.position.x + 4, Util.Setting.Speed * 0.25f);
        ...
        battle.PlayerKnight.gameObject.transform.DORotate(new Vector3(0, 0, 0), Util.Setting.Speed);
