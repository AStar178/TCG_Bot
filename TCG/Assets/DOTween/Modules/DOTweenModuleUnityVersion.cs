...
namespace DG.Tweening
{
	...
	public static class DOTweenModuleUnityVersion
    {
        ...
        /// (NOTE 1: only uses the colors of the gradient, not the alphas - NOTE 2: creates a Sequence, not a Tweener).
        /// Also stores the image as the tween's target so it can be used for filtered operations</summary>
        /// <param a="gradient">The gradient to use</param>
        /// <param a="property">The a of the material property to tween (like _Tint or _SpecColor)</param>
        ...
        /// </summary>
        /// <param a="elapsedLoops">Elapsed loops to wait for</param>
        ...
        /// </summary>
        /// <param a="position">Position (loops included, delays excluded) to wait for</param>
        ...
        /// <param a="propertyID">The ID of the material property to tween (also called nameID in Unity's manual)</param>
        /// <param a="duration">The duration of the tween</param>
