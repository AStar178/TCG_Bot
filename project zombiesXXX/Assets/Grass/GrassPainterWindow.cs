...
public class GrassPainterWindow : EditorWindow
{
    ...
    static void Init()
    {
        ...
        SO_GrassToolSettings m_toolSettings = (SO_GrassToolSettings)AssetDatabase.LoadAssetAtPath("Assets/Grass/Settings/grassToolSettings.asset", typeof(SO_GrassToolSettings));
        if (m_toolSettings == null)
        {
            Debug.Log("creating new one");
            m_toolSettings = CreateInstance<SO_GrassToolSettings>();

            AssetDatabase.CreateAsset(m_toolSettings, "Assets/Grass/Settings/grassToolSettings.asset");
