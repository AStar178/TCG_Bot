...
public class ResponseHandler : MonoBehaviour
{
    ...
    private void OnPickedResponse(Response response)
    {
        ...
        dialogueUi.wobbing = response.DialogueObject.jostar[0].wobbing;
        dialogueUi.wobbing1 = response.DialogueObject.jostar[0].wobbing1;
        dialogueUi.wobbing2 = response.DialogueObject.jostar[0].wobbing2;
    }
}
