...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// <summary>Tweens a Outliner's effectColor to the given value.
        /// Also stores the Outliner as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        ...
        /// <summary>Tweens a Outliner's effectColor alpha to the given value.
        /// Also stores the Outliner as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        ...
        /// <summary>Tweens a Outliner's effectDistance to the given value.
        /// Also stores the Outliner as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
